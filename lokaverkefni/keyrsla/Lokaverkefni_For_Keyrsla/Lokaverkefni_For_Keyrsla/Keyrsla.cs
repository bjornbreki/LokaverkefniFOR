    ...
    class Keyrsla
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (val1 == 1 && lok != 1)
	        {
                ...
                Console.WriteLine("Þú ert með " + stokkur_not.Count + " spil í stokknum þínum");
                Console.WriteLine("talvan er með " + stokkur_tol.Count + " spil í stokknum sínum");
                ...
                Console.ReadLine();
                if (stokkur_not.Count == 0)
                {
                    lok = 1;
                }
                else if (stokkur_tol.Count == 0)
                {
                    lok = 2;
                }
